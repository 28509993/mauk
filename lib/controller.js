...
const {includePlus, addPlus__, compilePlus__, includeModule, includeUsing} = require('./include')
...
function createUsingPlus(){
  const self = this
  const usingPlus = async function up(fullFile,referenceFile){
